/**
 *@author ARPITA GUPTA*  23/03/2018
 */
...
myFrame = new Frame("Assignment 1 Java 4-cse-A1 author RISHAB");
...
topLabel.setText("To select a file Click on BROWSE button.");

bottomLabel1.setText("To see final files , Click on SAVED FILES button.");
 }
...
// to get part of string substring() is used. Here (i+1) is the begining index of the substring.
                }
                return extension;
...
Path targetFile = Paths.get(checkOS() + "CopyOf-"+fileDialogue.getFile()+"." + getExtension(fileName));
//accepts sitable path from checkOS function
...
BufferedOutputStream bw = new BufferedOutputStream(new FileOutputStream(checkOS() + "split." + destIx + "." + getExtension(fileName)));
//getting path by checkOS()
